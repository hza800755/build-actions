...
export Op_name="Nanopc-T4"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 默认主题设置
export Mandatory_theme="ifit"              # 将bootstrap替换您需要的主题为必选主题(可自行更改您要的,源码要带此主题就行,填写名称也要写对) (填写主题名称,填0为不作修改)
export Default_theme="ifit"                # 多主题时,选择某主题为默认第一主题 (填写主题名称,填0为不作修改)
...
export Customized_Information="hza800755$(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
